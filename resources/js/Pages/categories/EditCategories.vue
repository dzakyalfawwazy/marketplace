...
const form = useForm({
    categoriesname: props.categoriesedit.categoriesname,
    icon: props.categoriesedit.icon,
    remarks: props.categoriesedit.remarks,
});

const submit = () => {
    form.patch(route('admin.categories.update',props.categoriesedit.id), {
